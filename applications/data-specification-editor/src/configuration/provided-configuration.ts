...
import type { BackendPackageService } from "@dataspecer/core-v2/project";
 ...
 */
export async function getConfiguration(dataSpecificationIri: string | null, dataPsmSchemaIri: string | null, backendService: BackendPackageService): Promise<Configuration> {
