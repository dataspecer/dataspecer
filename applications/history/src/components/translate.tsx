 ...
 * Picks the best translation for a LanguageString given the current language,
 * falling back to the first available language. Returns null for empty/missing strings.
 */

export function translateLanguageString(
