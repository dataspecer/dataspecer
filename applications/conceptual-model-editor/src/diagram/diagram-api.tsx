import {
  AlignmentHorizontalPosition, AlignmentVerticalPosition,
} from "../action/align-nodes";
import {
  type Node,
  type Edge,
  type Group,
...
interface VisualModelDiagramNodes {
   ...
   * @param visualModelDiagramNode is the node which info wants the to user view.
   */
