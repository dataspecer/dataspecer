    ...
    <div className="flex items-center space-x-4 hover:bg-accent">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent>
          ...
          {resource.types.includes(LOCAL_PACKAGE) && <DropdownMenuItem asChild><a href={import.meta.env.VITE_CONTROLLED_VOCAB_MANAGER + "?package-iri=" + encodeURIComponent(iri)}><BookOpen className="mr-2 h-4 w-4" /> {t("controlled-vocabularies")}</a></DropdownMenuItem>}
