  ...
  return (
    ...
    {!canSignIn ?
      ...
      <div className="flex login-card">
        {isSignedIn ?
          <button className="flex focus:outline-none hover:bg-red-300 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-2 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
          ...
          <button className="flex focus:outline-none hover:bg-green-700 focus:ring-4 focus:ring-green-300 text-sm px-2 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
        ...
        {!isSignedIn ?
          ...
          <div className="user-info">
            <img src={imageUrl} alt="User Avatar" className="avatar w-10 h-10" title={`Username: ${username}\nEmail: ${userEmail}\nScope: ${scope}`} />
          </div>
        }
      </div>
    }
