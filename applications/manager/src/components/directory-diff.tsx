...
export const DiffTreeVisualization = (props: {
  ...
  // return (
  //   <div className="flex gap-1 h-full">
  //     <div className="flex-1 overflow-auto border border-stone-200">
  //       <h3>Old:</h3>
  //       <div className="flex-1 max-h-[100%] h-full" ref={ref}>
  //       {/* https://www.jameskerr.blog/posts/responsive-sizing-for-react-arborist-tree-component/ ... otherwise the tree does not take full height */}
  //       <Tree data={oldRenderTree} className="react-arborist-main-tree" height={height} openByDefault>
  //         {StyledNode}
  //       </Tree>
  //       </div>
  //       <div>Test layout div</div>
  //     </div>
  //     <div className="flex-1 overflow-auto border border-stone-200">
  //       <h3>New:</h3>
  //       <Tree data={newRenderTree} className="react-arborist-main-tree" openByDefault>
  //         {StyledNode}
  //       </Tree>
  //     </div>
  //   </div>
...
//        <Tree
//         data={oldRenderTree}
//         className="react-arborist-main-tree flex-1 min-h-0"
//         height={100000000}
//         openByDefault
//       >
//         {StyledNode}
...
//     <div className="flex-1 flex flex-col overflow-hidden border border-stone-200">
//       <h3>New:</h3>
//       <Tree
//         data={newRenderTree}
//         className="react-arborist-main-tree flex-1 min-h-0"
...
//   return (
//   <div className="flex gap-1 h-full">
//     <div className="flex-1 flex flex-col border border-stone-200 overflow-hidden min-h-0">
//       <h3 className="p-2">Old:</h3>

//       {/* wrapper that will scroll and allow the Tree to fill available space */}
//       <div className="flex-1 min-h-0 overflow-auto">
//         <Tree
//           data={oldRenderTree}
//           className="react-arborist-main-tree h-full"
//           openByDefault
//         >
//           {StyledNode}
//         </Tree>
...
//       <div className="p-2">Test layout div</div>
//     </div>
...
// );
  ...
  //     <div className="flex-1 flex flex-col overflow-hidden border border-stone-200">
  //       <h3>Old:</h3>
  //       <Tree data={oldRenderTree} className="react-arborist-main-tree h-full" openByDefault>
  //         {StyledNode}
  //       </Tree>
  //       <div>Test layout div</div>
  //     </div>
  //     <div className="flex-1 overflow-auto border border-stone-200 h-full">
  //       <h3>New:</h3>
  //       <Tree data={newRenderTree} className="react-arborist-main-tree" openByDefault>
  //         {StyledNode}
  //       </Tree>
  ...
  //     <div className="flex-1 overflow-auto border border-stone-200">
  //       <h3>Old:</h3>
  //       <div className="flex-1 max-h-[100%] h-full">
  //       <Tree data={oldRenderTree} className="react-arborist-main-tree h-[8000px]" openByDefault>
  //         {StyledNode}
  //       </Tree>
  //       </div>
  //       <div>Test layout div</div>
