...
class TargetCase4ModelCreator implements ModelCreator{
...
createModel(): StructureModel{
  var model = new StructureModel();
    ...
    dalsiUzemiMestskehoObvodu.cimIri = "http://www.example.org/unikatniPredikat";
...
export default TargetCase4ModelCreator;