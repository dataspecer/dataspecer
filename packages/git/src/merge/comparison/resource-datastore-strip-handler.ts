...
export interface ResourceDatastoreStripHandler {
  ...
  /**
   * @todo TODO RadStr: Probably strip only the metas instead of any datastore, that means remove the {@link type} and remove the commented method from the implmentation
