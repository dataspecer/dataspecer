...
import { createSimpleGit, CreateSimpleGitResult, createUniqueDirectory, UniqueDirectory } from "./git-operations/simple-git-utils.ts";
...
export const TMP_CLONE_PATH_PREFIX = "tmp-clone";
export const TMP_DIRECTORY_FOR_GIT_PRIVATE: string = path.resolve(ROOT_DIRECTORY_FOR_PRIVATE_GITS + "/" + TMP_CLONE_PATH_PREFIX);
...
export type AllowedPrefixes = typeof MERGE_CONFLICTS_PRIVATE | typeof INTERNAL_COMPUTATION_FOR_IMPORT | typeof TMP_CLONE_PATH_PREFIX | AllowedPublicPrefixes;
