...
export const APPLICATION_GRAPH_OLD = "http://dataspecer.com/resources/local/application-graph-old";
export const APPLICATION_GRAPH_NEW = "http://dataspecer.com/resources/local/application-graph-new";
