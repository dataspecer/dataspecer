...
import {
  ...
  type ReadListSort,
  type ReadListResult,
} from '../assets/generated-app/static/src/shared/datasource/data-source.ts';
import {
  DEFAULT_PAGE_SIZE,
  DefaultReadListStrategy,
} from '../assets/generated-app/static/src/shared/operations/read-list-strategy.ts';
import type { OperationContext } from '../assets/generated-app/static/src/shared/operations/operation-strategy.ts';
import type {
  AggregateDescriptor,
  EntityModel,
