...
INSERT INTO "new_Resource" ("branch", "createdAt", "dataStoreId", "id", "iri", "linkedGitRepositoryURL", "modifiedAt", "parentResourceId", "projectIri", "representationType", "subtreeModifiedAt", "userMetadata") SELECT "branch", "createdAt", "dataStoreId", "id", "iri", "linkedGitRepositoryURL", "modifiedAt", "parentResourceId", "projectIri", "representationType", "subtreeModifiedAt", "userMetadata" FROM "Resource";
DROP TABLE "Resource";
