/*
  ...
  - You are about to drop the column `hasActiveMergeState` on the `Resource` table. All the data in the column will be lost.
...
INSERT INTO "new_Resource" ("branch", "createdAt", "dataStoreId", "hasUncommittedChanges", "id", "iri", "lastCommitHash", "linkedGitRepositoryURL", "modifiedAt", "parentResourceId", "projectIri", "representationType", "representsBranchHead", "subtreeModifiedAt", "userMetadata") SELECT "branch", "createdAt", "dataStoreId", "hasUncommittedChanges", "id", "iri", "lastCommitHash", "linkedGitRepositoryURL", "modifiedAt", "parentResourceId", "projectIri", "representationType", "representsBranchHead", "subtreeModifiedAt", "userMetadata" FROM "Resource";
DROP TABLE "Resource";
