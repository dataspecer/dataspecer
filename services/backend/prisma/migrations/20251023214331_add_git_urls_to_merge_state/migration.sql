...
INSERT INTO "new_MergeState" ("branchMergeFrom", "branchMergeTo", "conflictCount", "createdAt", "editable", "filesystemTypeMergeFrom", "filesystemTypeMergeTo", "id", "isUpToDate", "lastCommitHashMergeFrom", "lastCommitHashMergeTo", "lastCommonCommitHash", "mergeStateCause", "modifiedDiffTreeAt", "rootFullPathToMetaMergeFrom", "rootFullPathToMetaMergeTo", "rootIriMergeFrom", "rootIriMergeTo", "uuid") SELECT "branchMergeFrom", "branchMergeTo", "conflictCount", "createdAt", "editable", "filesystemTypeMergeFrom", "filesystemTypeMergeTo", "id", "isUpToDate", "lastCommitHashMergeFrom", "lastCommitHashMergeTo", "lastCommonCommitHash", "mergeStateCause", "modifiedDiffTreeAt", "rootFullPathToMetaMergeFrom", "rootFullPathToMetaMergeTo", "rootIriMergeFrom", "rootIriMergeTo", "uuid" FROM "MergeState";
