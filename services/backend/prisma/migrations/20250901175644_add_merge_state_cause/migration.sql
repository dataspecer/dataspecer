/*
  ...
  - Added the required column `mergeStateCause` to the `MergeState` table without a default value. This is not possible if the table is not empty.
