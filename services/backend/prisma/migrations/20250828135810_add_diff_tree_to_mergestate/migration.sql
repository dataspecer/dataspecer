...
INSERT INTO "new_MergeState" ("changedInEditable", "conflicts", "createdInEditable", "editable", "id", "lastCommitHashMergeFrom", "lastCommitHashMergeTo", "lastCommonCommitHash", "removedInEditable", "rootFullPathToMetaMergeFrom", "rootFullPathToMetaMergeTo", "rootIriMergeFrom", "rootIriMergeTo", "uuid") SELECT "changedInEditable", "conflicts", "createdInEditable", "editable", "id", "lastCommitHashMergeFrom", "lastCommitHashMergeTo", "lastCommonCommitHash", "removedInEditable", "rootFullPathToMetaMergeFrom", "rootFullPathToMetaMergeTo", "rootIriMergeFrom", "rootIriMergeTo", "uuid" FROM "MergeState";
