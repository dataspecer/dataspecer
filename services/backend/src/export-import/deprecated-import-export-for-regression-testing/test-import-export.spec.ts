...
//     let index = 0;
//     // TODO RadStr:
//     1) Ty jmena (v Gitu) musi byt projectIri
//     2) V tom testu musim nejak nastavit stejny projectIri
//     for (const [oldRelativePath, oldZipEntry] of Object.entries(oldZip.files)) {
//         const newZipEntry = Object.values(newZip.files)[index];
//         console.info(index++);          // TODO RadStr Debug: Debug print
...
//         const oldContentToCompareWithoutIri = deepOmit(oldContentToCompare, "iri");
//         delete oldContentToCompareWithoutIri._exportedAt;
//         delete oldContentToCompareWithoutIri._exportedBy;
//         const newContentToCompare = deepOmit(newContentAsJson, "projectIri");
//         const newContentToCompareWithoutIri = deepOmit(newContentToCompare, "iri");
//         delete newContentToCompareWithoutIri._exportedAt;
//         delete newContentToCompareWithoutIri._exportedBy;
//         expect(oldContentToCompareWithoutIri).toStrictEqual(newContentToCompareWithoutIri);
