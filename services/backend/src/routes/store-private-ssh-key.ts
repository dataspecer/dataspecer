...
export const sshDirectoryForDS = path.resolve("./database/ds-users/.ssh");
...
export const storePrivateSSHKeyHandler = asyncHandler(async (request: express.Request, response: express.Response) => {
  ...
  storeNewPrivateSSHKeyToBackend(privateSSHKey, userSSHIdentifer, gitProviderLowercase);
...
export function storeNewPrivateSSHKeyToBackend(privateSSHKey: string, userSSHIdentifer: string | null, gitProviderName: GitProviderNamesAsType) {
