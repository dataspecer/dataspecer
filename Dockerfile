...
RUN bunx turbo run build --cache=local: --concurrency 100% --filter=data-specification-editor --filter=conceptual-model-editor --filter=history --filter=manager --filter=backend^...
